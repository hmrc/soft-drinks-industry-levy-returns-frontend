...
trait DataHelper {
  ...
  def testSmallProducer(alias: String, sdilRef: String, litreage: (Long, Long)): SmallProducer =
    SmallProducer(alias = alias, sdilRef = sdilRef, litreage = litreage)
