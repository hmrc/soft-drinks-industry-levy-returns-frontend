...
class PackagingSiteDetailsSummarySpec extends SpecBase {
  ...
  val addressWith3AddressLines =
    Site(UkAddress(List("The house", "The Road", "ugzhkxcajkcjfrqsgkjruzlmsxytwhg vdg"), "NW88 8II"), None, Some("Test trading name 1"), None)

  val address44Characters = Site(UkAddress(List("29 Station Rd", "The Railyard", "Cambridge"), "CB1 2FP"), Some("10"), None, None)

  val address45Characters = Site(UkAddress(List("29 Station Pl.", "The Railyard", "Cambridge"), "CB1 2FP"), None, None, None)

  val address47Characters = Site(UkAddress(List("29 Station Place", "The Railyard", "Cambridge"), "CB1 2FP"), Some("10"), None, None)

  val address49Characters = Site(UkAddress(List("29 Station PlaceDr", "The Railyard", "Cambridge"), "CB1 2FP"), None, None, None)

  val address50Characters = Site(UkAddress(List("29 Station Place Dr", "The Railyard", "Cambridge"), "CB1 2FP"), Some("10"), None, None)
  ...
  val packagingSiteListWith3 =
    Map(("rieajnldkaljnk13", address45Characters), ("jfkladnlr12", address47Characters), ("jgklaj;ll;e;o", address49Characters))
  ...
  "address formatting within Row2" - {
    ...
    "should autowrap and place a break before the post code if the address line and post code length is between 98 & 103 characters" in {
      ...
      val expectedAddressContent      =
        HtmlContent("29 Station Rd, This address will auto wrap but not in postcode, it is 4 lines 103 char, Cambridge, <br>CB1 2FP")
    ...
    "should place a break after a trading name AND autowrap and place a break before the post code if the address line " +
      "and post code length is between 98 & 103 characters" in {
        ...
        val expectedAddressContent      = HtmlContent(
          "Test Trading Name Inc<br>29 Station Rd, This address will auto wrap but not " +
