  ...
  "Brought Into the UK View " - {
    ...
    "should include a legend with the expected heading " in {
      ...
      legend.get(0).getElementsByClass(Selectors.legendHeading).text() mustBe
        "Are you reporting liable drinks you have brought into the UK from anywhere outside of the UK?"
    }
    ...
    "when there are form errors" - {
      ...
      "contains a message that links to field with error" in {
        ...
        errorSummary.text() mustBe "Select yes if you are reporting liable drinks you have brought into the UK from anywhere outside of the UK"
      }
    }
