...
class OwnBrandsControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val ownBrandsRoute = routes.OwnBrandsController.onPageLoad(NormalMode).url
  ...
  "OwnBrands Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(OwnBrandsPage, true).success.value
