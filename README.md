...
Levy band rates are managed in the backend service (`soft-drinks-industry-levy`). The frontend calls the backend's `/levy/calculate` endpoint to calculate levy amounts. No rate configuration is required in this frontend service.
