...
echo "$className;format="decap"$.subHeading = $className;format="decap"$" >> ../conf/messages.en
echo "$className;format="decap"$.hint = $className;format="decap"$" >> ../conf/messages.en
