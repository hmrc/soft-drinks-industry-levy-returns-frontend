  ...
  "SecondaryWarehouseDetailsController" should {
    "Ask for if user wants to add more warehouses" in {
      ...
      WsTestClient.withClient { client =>
        val result1 = client
          .url(s"$baseUrl/secondary-warehouse-details")
      ...
      val journeyConfigToBePosted: JourneyConfig = JourneyConfig(
        ...
        options = JourneyOptions(
          ...
          phaseFeedbackLink = Some(
            s"http://localhost:9250/contact/beta-feedback?service=soft-drinks-industry-levy-returns-frontend&backUrl=http%3A%2F%2Flocalhost%3A8703%2Fsoft-drinks-industry-levy-returns-frontend%2Fsecondary-warehouse-details"
          ),
